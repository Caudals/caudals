...
- Supabase is still present in legacy payment actions, Stripe webhook support helpers, rate limiting, export jobs, waitlist ingestion, and analytics event storage while those data paths are migrated.
