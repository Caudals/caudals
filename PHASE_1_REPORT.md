...
- Remaining pre-pivot self-serve route files for `/browse`, `/requester`, and `/contributor` still exist in the codebase, but the proxy hides them by default during Phase 1.
