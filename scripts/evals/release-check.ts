...
async function main(){
 ...
 const migrations=await pool.query("SELECT name FROM public.evals_migration_history WHERE name LIKE '03%_evals_%' ORDER BY name");
 ...
 const needed=["034_evals_connections.sql","035_evals_generation.sql","036_evals_scoring.sql","037_evals_reports.sql","038_evals_operations.sql","039_evals_stage_c.sql"];
