...
async function main(){
 ...
 try{
  ...
  for(const name of ['031_evals_identity.sql','032_evals_evidence.sql','033_evals_execution.sql','034_evals_connections.sql','035_evals_generation.sql','036_evals_scoring.sql','037_evals_reports.sql','038_evals_operations.sql','039_evals_stage_c.sql','040_evals_private_runner.sql','041_evals_monitoring.sql','042_evals_monitor_schedule_reasons.sql','043_evals_expert_work.sql','044_evals_improvement_releases.sql','045_evals_entitlement_lock.sql']){
