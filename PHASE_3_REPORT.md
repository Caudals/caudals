...
- Latest platform completion gate readback on image `mariomedpar/caudals:4e3699717405fad789ff2966fab7a849fe735a03` passes Sentry runtime delivery, Alertmanager external routing, route, `/v1/datasets` catalogue-deferral, operator-auth, observability-stack, operations-stack, secret-scan, runtime-secret, object-storage/CVAT waivers, and pentest-waiver checks. Set `CAUDALS_PENTEST_GATE_ENABLED=true` to require the quarterly tracker again.
