...
function draftSystemPrompt() {
  return [
    ...
    "For every case, supportingQuote must be copied exactly from one listed source anchor. expected must be copied exactly as a contiguous substring of supportingQuote, preserving all numbers and units. Never paraphrase expected, calculate a new value, or add any fact that is absent from the quote.",
