 ...
 * Updated to use DO Spaces for active storage URLs.
 */
...
export function isStorageUrl(url: string): boolean {
  ...
  // Keep legacy object URLs readable while stored records are migrated.
 ...
 * Supports both DO Spaces CDN and legacy absolute object URLs.
 */
