...
export const operatorModuleSummaries: OperatorModuleSummary[] = [
  ...
  },
  {
    key: "datasets",
    title: "Datasets",
    description: "Dataset families, versions, manifests, modality contracts, lineage, and sample previews.",
    anchorRecords: ["dataset", "dataset_version", "modality_contract", "lineage_event"],
    totalRecords: 13,
    blockedRecords: 2,
    savedViews: ["Released", "Lineage gaps", "Modality review"],
  },
  {
    key: "labeling",
    title: "Labeling",
  ...
  },
  {
    key: "quality",
    title: "Quality",
    description: "QA reports, enrichment manifests, scorecards, exception logs, and buyer-ready verdicts.",
    anchorRecords: ["qa_report", "enrichment_manifest"],
    totalRecords: 22,
    blockedRecords: 4,
    savedViews: ["Exceptions", "Enrichment review", "Release blockers"],
  },
  {
    key: "privacy",
...
const fixtureWorkItems: OperatorWorkItem[] = [
  ...
  },
  {
    ...
    id: "mc_01J2VIDEO",
    title: "Mediterranean crop imagery video contract",
    state: "review",
