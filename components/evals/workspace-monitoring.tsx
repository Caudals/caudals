...
type Schedule={id:string;evaluation_id:string;target_revision_id:string;suite_version_id:string;timezone:string;
  ...
  reason_code:string|null;next_due_at:string;version:number;latest_dispatch_status:string|null;latest_dispatch_reason:string|null;latest_alert_status:string|null};
