        ...
        <div className="flex flex-col gap-6 rounded-[1.8rem] border border-border/80 bg-card p-6 md:flex-row md:items-center md:justify-between">
          <div className="max-w-xl space-y-1">
            ...
            <h3 className="text-2xl font-semibold text-foreground">
              Resources to accelerate your next dataset sprint
            </h3>
            <p className="text-sm text-muted-foreground">
              Save time with proven playbooks, security documentation, and planning templates used by
              teams already live on Caudals.
            </p>
          </div>
