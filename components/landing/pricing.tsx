      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 sm:gap-10 sm:px-6 lg:gap-12 lg:px-12">
        ...
        <div className="grid gap-5 sm:gap-6 lg:grid-cols-3">
          {plans.map((plan, index) => (
            ...
            >
              <div>
                <h3 className="text-xl font-semibold text-foreground sm:text-2xl">{plan.name}</h3>
              ...
              <div className="mt-auto space-y-3 sm:space-y-4">
                <div>
                  <p className="pb-3 text-2xl font-semibold text-foreground sm:pb-4 sm:text-3xl">{plan.price}</p>
                </div>
